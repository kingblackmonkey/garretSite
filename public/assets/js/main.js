...
// form to api request for seding email
$(function(){
...
if(form ){
	...
	try {
      ...
      // console.log(123)
		...
		if 	( validateEmail(email) && evt.target.message.value.length > 5 ){
       ...
       let response =  await axios({
        ...
        $.notify( response.data.message,  {  className: 'success', globalPosition:'top left'});
        setTimeout(function(){ location.assign('/'); }, 3000);
				...
				// console.dir('error from log in', error)
